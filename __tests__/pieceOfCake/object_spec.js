describe('for object', () => {
  ...
  it('should get object prototype for an object', () => {
    ...
    // console.log('Debug: ', Object.getPrototypeOf(emptyObject));
    // --end->
  ...
  it('should simulate constructor using function, and use function\'s prototype as definition', () => {
    ...
    // --end->
    // console.log('Debug: ', prototypeOfRabbitFunction === functionPrototype, prototypeOfRabbitInstance === rabbitFunctionPrototype);
